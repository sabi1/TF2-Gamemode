...
local gib_rightleg = _G.GIB_RIGHTLEG or 1
local gib_rightarm = _G.GIB_RIGHTARM or 2
local gib_torso = _G.GIB_TORSO or 3
local gib_head = _G.GIB_HEAD or 4
local gib_organ = _G.GIB_ORGAN or 5
