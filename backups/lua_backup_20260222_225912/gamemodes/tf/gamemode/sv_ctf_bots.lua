...
local tf_bot_sense_interval = CreateConVar("tf_bot_sense_interval", "0.25", {FCVAR_ARCHIVE, FCVAR_NOTIFY})
local tf_bot_objective_interval = CreateConVar("tf_bot_objective_interval", "0.75", {FCVAR_ARCHIVE, FCVAR_NOTIFY})
local tf_bot_avoidance_interval = CreateConVar("tf_bot_avoidance_interval", "0.10", {FCVAR_ARCHIVE, FCVAR_NOTIFY})
local tf_bot_repath_interval = CreateConVar("tf_bot_repath_interval", "1.75", {FCVAR_ARCHIVE, FCVAR_NOTIFY})
local tf_bot_nav_budget_ms = CreateConVar("tf_bot_nav_budget_ms", "2.5", {FCVAR_ARCHIVE, FCVAR_NOTIFY})
local tf_bot_perf_scale_start = CreateConVar("tf_bot_perf_scale_start", "12", {FCVAR_ARCHIVE, FCVAR_NOTIFY})
local tf_bot_perf_scale_max = CreateConVar("tf_bot_perf_scale_max", "3", {FCVAR_ARCHIVE, FCVAR_NOTIFY})
local tf_bot_breakable_check_interval = CreateConVar("tf_bot_breakable_check_interval", "0.20", {FCVAR_ARCHIVE, FCVAR_NOTIFY})
...
local function GetAdaptivePerfScale()
	...
	return math.Clamp(botCount / startCount, 1, maxScale)
end
