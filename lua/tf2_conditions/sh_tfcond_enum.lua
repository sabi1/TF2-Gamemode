-- shared enumeration for TF condition IDs
-- mirrors ETFCond enum exactly from Source SDK 2013 (tf_shareddefs.h)
-- references: https://github.com/ValveSoftware/source-sdk-2013/blob/master/src/game/shared/tf/tf_shareddefs.h
...
local ETFCondName = {}
for k,v in pairs(ETFCond) do ETFCondName[v] = k end

return {
    ETFCond = ETFCond,
    ETFCondName = ETFCondName,
}
