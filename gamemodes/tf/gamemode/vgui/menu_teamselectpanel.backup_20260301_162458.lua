...
function PANEL:Init()
	...
	self.ModelBG = vgui.Create("DModelPanel", self)
	self.ModelBG:SetModel("models/vgui/ui_team01.mdl")
	self.ModelBG:SetCamPos(Vector(90, 0, 40))
	self.ModelBG:SetPos(0, 0)
	self.ModelBG:SetFOV(70)
	self.ModelBG:SetZPos(-2)
	self.ModelBG:SetMouseInputEnabled(false)
	self.ModelBG:SetKeyboardInputEnabled(false)
	function self.ModelBG:LayoutEntity(_) return end
	function self.ModelBG:Paint(w, h)
