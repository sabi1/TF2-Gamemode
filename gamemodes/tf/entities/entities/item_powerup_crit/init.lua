ENT.PrintName = "Temporary Crit Powerup"
...
ENT.Type = "anim"
ENT.Base = "item_base"
ENT.Model = "models/pickups/pickup_powerup_crit.mdl"
ENT.RespawnTime = 90
...
function ENT:PlayerTouched(pl)
	pl:AddCond(TF_COND_CRITBOOSTED_RUNE_TEMP, 30, pl)
	pl:EmitSound("Powerup.PickUpTemp.Crit", 75, 100)
